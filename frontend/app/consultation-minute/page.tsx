  ...
  return (
    <div>
      ...
      <section className="bg-warm">
        <div className="mx-auto max-w-3xl px-5 py-16 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-lg text-ink/75">
            ...
            <strong className="text-aubergine">2,90 € / minute</strong>. Vous
          ...
          {offline && (
            <div className="mx-auto mt-6 max-w-md rounded-2xl border border-greige/70 bg-ivory p-5">
              ...
              <a
                ...
                className="mt-3 inline-block text-sm font-medium text-coral hover:underline"
              >
      ...
      <section className="mx-auto max-w-6xl px-5 py-16">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {[
            ...
            >
              <div className="mx-auto mb-4 flex h-11 w-11 items-center justify-center rounded-full bg-coral/10 font-serif text-xl font-semibold text-coral">
                {s.n}
              </div>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 text-center">
        ...
        <ul className="mx-auto mt-8 max-w-xl space-y-4 text-left text-sm text-ink/80">
        ...
        <a
          href={online ? "/consultants" : "/dashboard"}
          className="mt-10 inline-block rounded-full bg-coral px-8 py-3.5 font-medium text-white shadow-card transition hover:bg-coral-dark"
        >
